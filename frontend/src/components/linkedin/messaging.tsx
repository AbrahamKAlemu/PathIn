...
export function MessagingBar() {
  return (
    <div className="messaging-bar fixed bottom-0 right-0 z-50 flex h-[38px] w-[266px] items-center rounded-tl-[10px] border border-[#d4d4d4] bg-white px-[9px] shadow-[0_-3px_12px_rgba(0,0,0,0.08)]">
      <Avatar
